...
function App() {
  return (
    <div className='mainDiv'>
      <header style={{ backgroundImage: `url(${buildings})`, backgroundSize: "100%", height: "185px" }}>

      </header>
      <div className='middlePage'>
        <div>
          <h1 className='mainTitles'>BOTA UMA FRASE <br></br>
            ENGRAÇADA AQUI</h1>
        </div>
        <div className='mainText'>
          Lornyhcpole eu te amoooooem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.
      ...
      <footer style={{ backgroundImage: `url(${excavator})`, backgroundSize: "100%", height: "264px" }}>
